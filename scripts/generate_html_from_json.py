...
def generate_html_from_json(json_file_path, output_dir=None):
    ...
    # Set global execution times (required for HTML generation)
    global_vars.execution_start_time = time.time() - 60  # 1 minute ago
    # execution_end_time is computed automatically when accessed
