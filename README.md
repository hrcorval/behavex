...
### JSON Report
Contains information about test scenarios and execution status. This is the first report generated by BehaveX, which is used to generate the HTML report. Available at:
```bash
