...
### JSON Report
Contains information about test scenarios and execution status. This is the first report generated by BehaveX, which is used to generate all other reports. Available at:
```bash
